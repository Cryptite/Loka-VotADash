...
Cursor.prototype.nextObject = function (options, callback) {
    ...
    if (self.state == Cursor.INIT) {
        ...
        var queryOptions = {exhaust: self.exhaust, raw: self.raw, readPreference: self.readPreference, connection: self.connection, checkKeys: false};
...
var getMore = function (self, options, callback) {
    ...
    try {
        ...
        // Set up options
        var command_options = {
            readPreference: self.readPreference, raw: self.raw, connection: self.connection
        };
...
Cursor.prototype.explain = function (callback) {
    ...
    var cursor = new Cursor(this.db, this.collection, this.selector, this.fields, {
        skip: this.skipValue, limit: limit, sort: this.sortValue, hint: this.hint, explain: true, snapshot: this.snapshot, timeout: this.timeout, tailable: this.tailable, batchSize: this.batchSizeValue, slaveOk: this.slaveOk, raw: this.raw, readPreference: this.readPreference, returnKey: this.returnKey, maxScan: this.maxScan, min: this.min, max: this.max, showDiskLoc: this.showDiskLoc, comment: this.comment, awaitdata: this.awaitdata, oplogReplay: this.oplogReplay, numberOfRetries: this.numberOfRetries, dbName: this.dbName
    });
